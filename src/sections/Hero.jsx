  ...
  return (
    ...
    >
      <div
       ...
       w-full max-xl:padding-x pt-28 mt-16"
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red inline-block mt-3">Spiral</span>{" "}
          Jewelry
        </h1>
        <p
        ...
        >
          Discover stylish Spiral arrivals, quality comfort, and innovation for
          your active life.
        </p>
